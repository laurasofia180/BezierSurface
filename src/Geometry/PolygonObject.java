...
public class PolygonObject {
     ...
     */
    public void drawObject(DibujarBezier dc) {
        for (Edge edge : edges) {
            drawOneLine(dc, edge);
        }
    }
     ...
     */
    public void drawOneLine(DibujarBezier dc, Edge edge) {
    ...
    /**
     * Transform an object given a transformation. The vertices of the object
     * are transformed.
     *
    ...
    public void setCentroid(Vector4 centroid) {
        System.out.println("Centroid is: " + centroid.getX() + "," + centroid.getY() + "," + centroid.getZ());
